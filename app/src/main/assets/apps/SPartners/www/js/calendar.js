(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<span class="prev" title="上一月" data-calendar-arrow-date><img src="../images/82.png" /></span>',
            '<a href="javascript:;" data-calendar-display-date class="calendar-display">',
            '{yyyy}/<span>{mm}</span>',
            '</a>',
            '<span class="next" title="下一月" data-calendar-arrow-date><img src="../images/83.png" /></span>',
            '</div>',
            '</div>',
    ...
    Calendar.prototype = {
        ...
        getDaysHtml: function(y, m) {
            ...
            return $('<li></li>').width(this.options.width-20).append($days);
        },
        ...
        resize: function() {
            var w = this.width,
                ...
                rcH = this.$element.find('.calendar-rc').outerHeight();

            this.$element.width(w).height(h + hdH + rcH)
                .find('.calendar-inner, .view')
                .css('width', w + 'px');

            //this.$element.find('.calendar-ct').width(w).height(h+rcH);
