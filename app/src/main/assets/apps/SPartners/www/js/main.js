...
//});
  ...
  $(".directive-box a").click(function(){
    $(".hover,.box").hide();
  });
   
  //我的活动-分享
  $(".header-share").click(function(){
    $(".share-box,.hover02").show();  
  });
  ...
  $(".add-active04").click(function(){
    $(".my-code,.hover03").show();   
  });
  
  $(".my-code .esc").click(function(){
    $(".my-code,.hover03").hide();   
  });
  
  
  function calcHW(){
   var conheight = window.outerHeight;
   $(".past-img").css({"height":conheight-50});
  }
  calcHW();
  ...
  $(".header-attendance a").click(function(){
    $(".goods-box,.hover").show();
  });
